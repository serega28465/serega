...
<div class="row">
	<div class="col-md-3 col-xs-12">
		<c:if test="${category eq null}">
			<form:form class="form-horizontal" action="/admin/commodity" method="GET" modelAttribute="filter" id="filter">
				<custom:hiddenInputs excludeParams="search, minPrice, maxPrice, producerIds, CategoryIds"/>
				...
				<div class="form-group">
					<div class="col-sm-12">
						<form:checkboxes items="${producers}" path="producerIds" itemLabel="producer" itemValue="id"/>
					</div>
				</div>
				<c:forEach items="${categorys}" var="category">
					<div class="form-group">
						<label class="col-sm-12">${category.category}</label>
					</div>
					<div class="form-group">
						<div class="col-sm-12">
							<form:checkboxes items="${category.category}" itemLabel="category" itemValue="id" path="category"/>
						</div>
					</div>
				</c:forEach>
				<div class="form-group">
			...
			<div class="col-md-12 col-xs-12">
				<form:form class="form-horizontal" action="/admin/commodity" method="POST" modelAttribute="commodity" enctype="multipart/form-data">
					...
					<div class="form-group">
    					...
    					<div class="col-sm-10">
      						<form:select class="form-control" path="producer" itemLabel="producer" itemValue="id" items="${producers}"/>
    					</div>
  					</div>
					<div class="form-group">
	...
	<c:forEach items="${page.content}" var="commodity">
				<div class="row">
					...
					<div class="col-md-2 col-xs-2">${commodity.producer.producer}</div>
