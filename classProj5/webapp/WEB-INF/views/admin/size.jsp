		...
		<div class="container-fluid">
			...
			<div class="collapse navbar-collapse" id="myNavbar">
				<ul class="nav navbar-nav">
					...
					<li class="active"><a href="/admin/size">Розмір</a><span
...
<div class="row">
	<div class="col-md-3 col-xs-12">
		<form:form modelAttribute="filter" action="/admin/size" method="get" class="form-inline">
		...
		<div class="row">
			<div class="col-md-12 col-xs-12">
				<form:form class="form-horizontal" action="/admin/size" method="POST" modelAttribute="size">
					...
					<div class="form-group">
						<label for="category" class="col-sm-offset-2 col-sm-10"><form:errors path="size"/></label>
					</div>
					<div class="form-group">
			...
			<div class="col-md-6 col-xs-6 text-center">
				<div class="dropdown">
					...
					<ul class="dropdown-menu">
						<custom:sort innerHtml="Name asc" paramValue="size"/>
						<custom:sort innerHtml="Name desc" paramValue="size,desc"/>
					</ul>
				</div>
			</div>
			<div class="col-md-6 col-xs-6 text-center">
