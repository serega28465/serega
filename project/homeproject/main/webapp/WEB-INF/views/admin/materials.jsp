	...
	<div class="col-md-7 col-xs-12">
		<div class="row">
			<div class="col-md-12 col-xs-12">
				<form:form class="form-horizontal" action="/admin/materials" method="POST" modelAttribute="materials">
					<div class="form-group">
    					<label for="verh" class="col-sm-2 control-label">Verh</label>
    					<div class="col-sm-10">
      						<form:select class="form-control" path="verh" id="verh" items="${verhs}" itemValue="verh" itemLabel="verh"/>
    					</div>
  					</div>
  					<div class="form-group">
    					<label for="niz" class="col-sm-2 control-label">Niz</label>
    					<div class="col-sm-10">
      						<form:select class="form-control" path="niz" id="niz" items="${nizs}" itemValue="niz" itemLabel="niz"/>
    					</div>
  					</div>
  					<div class="form-group">
    					<label for="obechaika" class="col-sm-2 control-label">Obechaika</label>
    					<div class="col-sm-10">
      						<form:select class="form-control" path="obechaika" id="obechaika" items="${obechaikas}" itemValue="obechaika" itemLabel="obechaika"/>
    					</div>
  					</div>
  					<div class="form-group">
    					<label for="grif" class="col-sm-2 control-label">Grif</label>
    					<div class="col-sm-10">
      						<form:select class="form-control" path="grif" id="grif" items="${grifs}" itemValue="grif" itemLabel="grif"/>
    					</div>
  					</div>
