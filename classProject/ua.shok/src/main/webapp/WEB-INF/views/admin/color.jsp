		...
		<div class="container-fluid">
			...
			<div class="collapse navbar-collapse" id="myNavbar">
				<ul class="nav navbar-nav">
					...
					<li><a href="/admin/color">Color</a><span
		...
		<div class="row">
			...
			<c:forEach items="${colors}" var="color">
				<div class="row">
					...
					<div class="col-md-4 col-xs-4"><a class="btn btn-warning" href="/admin/producer/update/${color.id}">update</a></div>
					<div class="col-md-4 col-xs-4"><a class="btn btn-danger" href="/admin/producer/delete/${color.id}">delete</a></div>
				</div>
			</c:forEach>
	</div>
