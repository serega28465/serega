		...
		<div class="row">
			...
			<c:forEach items="${models}" var="model">
				<div class="row">
					...
					<div class="col-md-4 col-xs-4"><a class="btn btn-warning" href="/admin/category/update/${model.id}">update</a></div>
					<div class="col-md-4 col-xs-4"><a class="btn btn-danger" href="/admin/category/delete/${model.id}">delete</a></div>
				</div>
			</c:forEach>
	</div>
