		...
		<div class="container-fluid">
			...
			<div class="collapse navbar-collapse" id="myNavbar">
				<ul class="nav navbar-nav">
					...
					<li class="active"><a href="/admin/mechanika">Механіка</a><span
...
<div class="row">
	<div class="col-md-3 col-xs-12">
		<form:form modelAttribute="filter" action="/admin/mechanika" method="get" class="form-inline">
	...
	<div class="col-md-7 col-xs-12">
		<div class="row">
			<div class="col-md-12 col-xs-12">
				<form:form class="form-horizontal" action="/admin/mechanika" method="POST" modelAttribute="mechanika">
					<custom:hiddenInputs excludeParams="mechanika"/>
					<div class="form-group">
						<label for="mechanika" class="col-sm-offset-2 col-sm-10"><form:errors path="mechanika"/></label>
					</div>
					<div class="form-group">
    					<label for="name" class="col-sm-2 control-label">Name</label>
    					<div class="col-sm-10">
      						<form:input class="form-control" path="mechanika" id="mechanika"/>
    					</div>
  					</div>
  					<div class="form-group">
		...
		<div class="row">
			...
			<c:forEach items="${page.content}" var="mechanika">
				<div class="row">
			...
			<div class="col-md-6 col-xs-6 text-center">
				<div class="dropdown">
					...
					<ul class="dropdown-menu">
						<custom:sort innerHtml="Name asc" paramValue="mechanika"/>
						<custom:sort innerHtml="Name desc" paramValue="mechanika,desc"/>
					</ul>
				</div>
			</div>
			<div class="col-md-6 col-xs-6 text-center">
